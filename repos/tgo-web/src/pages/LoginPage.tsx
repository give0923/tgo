...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-blue-50/50 flex items-center justify-center min-h-screen font-sans antialiased">
      <div className="w-full max-w-md px-8 py-10 bg-white/80 backdrop-blur-lg rounded-xl shadow-lg border border-gray-200/60">
        ...
        <h2 className="text-2xl font-semibold text-center text-gray-700 mb-6">{t('auth.login.title')}</h2>
