    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0">
          <h3 className="text-lg font-semibold text-gray-900">{t('knowledge.selectModal.title', '选择知识库')}</h3>
          <button
            onClick={onClose}
            ...
            {isLoading && (
              <div className="flex items-center justify-center py-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm">{t('knowledge.selectModal.loading', '正在加载知识库...')}</p>
                </div>
              </div>
            )}
                ...
                return (
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <div className={`text-sm font-medium ${isSelected ? 'text-blue-900' : 'text-gray-800'}`}>
                          {knowledgeBase.title}
                        </div>
