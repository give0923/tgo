  ...
  if (tools.length === 0) {
    return (
      <div className={`text-center py-12 ${className}`}>
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-2">{t('mcp.tools.list.emptyTitle', '暂无工具')}</h3>
        ...
        <div className="mt-6">
          <button className="inline-flex items-center px-4 py-2 bg-blue-500 text-white text-sm rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
