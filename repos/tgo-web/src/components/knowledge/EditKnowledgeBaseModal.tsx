    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-800">{t('knowledge.edit', '编辑知识库')}</h2>
          <button
            onClick={handleClose}
            disabled={isLoading}
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-4">
            {/* Icon Field */}
            <div>
              <label htmlFor="edit-kb-icon" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            {/* Name Field */}
            <div>
              <label htmlFor="edit-kb-name" className="block text-sm font-medium text-gray-700 mb-1">
                {t('knowledge.name', '知识库名称')} <span className="text-red-500">*</span>
              </label>
              <input
                id="edit-kb-name"
                type="text"
            ...
            {/* Description Field */}
            <div>
              <label htmlFor="edit-kb-description" className="block text-sm font-medium text-gray-700 mb-1">
                {t('knowledge.description', '知识库描述')} <span className="text-red-500">*</span>
              </label>
              <textarea
            ...
            {/* Tags Field */}
            <div>
              <label htmlFor="edit-kb-tags" className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div className="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="px-4 py-2 text-sm font-medium text-white bg-blue-500 border border-transparent rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
            >
              {isLoading ? (
                <>
