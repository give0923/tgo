...
export const AgentCardSkeleton: React.FC = () => {
  return (
    <div className="bg-white/80 backdrop-blur-md rounded-lg p-5 shadow-sm border border-gray-200/60 animate-pulse">
...
export const AgentsPageSkeleton: React.FC = () => {
  return (
    <main className="flex-grow flex flex-col bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      {/* Pagination skeleton */}
      <div className="px-6 py-4 border-t border-gray-200/80 bg-white/60 backdrop-blur-lg">
        <div className="flex justify-between items-center animate-pulse">
