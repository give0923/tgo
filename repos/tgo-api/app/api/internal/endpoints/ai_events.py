...
def _handle_manual_service_request(event: AIServiceEvent, project: Project, db: Session) -> dict:
    """Persist a manual service request generated by the AI service."""
    ...
    notification_type = (payload.notification_type or "").strip() or None
    ...
    logger.info(
        "Manual service request recorded from AI event",
        extra={
